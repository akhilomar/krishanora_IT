        ...
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a">
          ...
          <div style="background:#f9f9f9;padding:32px;border:1px solid #eee;border-top:none;border-radius:0 0 12px 12px">
            <table style="width:100%;border-collapse:collapse;margin-bottom:24px">
              ...
              <tr>
                <td style="padding:10px 0;color:#666;font-size:14px;border-bottom:1px solid #eee">Project type</td>
                <td style="padding:10px 0;font-size:14px;border-bottom:1px solid #eee">${type}</td>
              </tr>
              <tr>
                <td style="padding:10px 0;color:#666;font-size:14px">Budget</td>
